...
const shellTranslations = {
  en: {
    ...
    navBefore: 'Before you start', navFirst: 'First run', navProvider: 'Configure providers', navMarket: 'Instruments & market data', navTrade: 'Orders & risk', navPortfolio: 'Accounts & portfolio', navIntelligence: 'Intelligence', navAi: 'AI & Quant', navArchitecture: 'Architecture & data', navTroubleshooting: 'Troubleshooting',
  ...
  'zh-CN': {
    ...
    navBefore: '开始之前', navFirst: '首次启动', navProvider: '配置 Provider', navMarket: '标的与行情', navTrade: '下单与风控', navPortfolio: '账户与组合', navIntelligence: 'Intelligence', navAi: 'AI 与 Quant', navArchitecture: '架构与数据', navTroubleshooting: '故障排查',
  ...
  ko: {
    ...
    navBefore: '시작 전', navFirst: '첫 실행', navProvider: 'Provider 구성', navMarket: '종목 & 시장 데이터', navTrade: '주문 & 리스크', navPortfolio: '계정 & 포트폴리오', navIntelligence: '인텔리전스', navAi: 'AI & Quant', navArchitecture: '아키텍처 & 데이터', navTroubleshooting: '문제 해결',
  ...
  ja: {
    ...
    navBefore: '始める前に', navFirst: '初回起動', navProvider: 'Provider 設定', navMarket: '銘柄と市場データ', navTrade: '注文とリスク', navPortfolio: '口座とポートフォリオ', navIntelligence: 'インテリジェンス', navAi: 'AI & Quant', navArchitecture: '構成とデータ', navTroubleshooting: 'トラブルシューティング',
