...
const workflowCopy = {
  "zh-CN": {
    ...
    "demo.disclosure": "15 秒流程演示 · 示例数据，非实时交易",
    "demo.step0": "描述需求",
    "demo.step1": "AI 生成",
    "demo.step2": "回测验证",
    "demo.step3": "审核部署",
  ...
  "en": {
    ...
    "demo.disclosure": "15-second walkthrough · Illustrative data, no live trades",
    "demo.step0": "Describe",
    "demo.step1": "Generate",
    "demo.step2": "Backtest",
    "demo.step3": "Approve",
  ...
  "ja": {
    ...
    "demo.disclosure": "15秒のフロー紹介 · サンプルデータ・実取引なし",
    "demo.step0": "要望",
    "demo.step1": "AI作成",
    "demo.step2": "テスト",
    "demo.step3": "承認",
  ...
  "ko": {
    ...
    "demo.disclosure": "15초 과정 데모 · 예시 데이터, 실제 거래 아님",
    "demo.step0": "요청",
    "demo.step1": "AI 생성",
    "demo.step2": "백테스트",
    "demo.step3": "승인",
