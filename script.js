...
const translations = {
  en: {
    ...
    'hero.download': 'See what it does', 'hero.source': 'Download Nightly', 'hero.support': 'Support the project', 'hero.explore': 'See who it is for', 'hero.note': 'Runs on your device · No custody · Start read-only or simulated',
  ...
  'zh-CN': {
    ...
    'hero.download': '看看它能做什么', 'hero.source': '下载 Nightly 版', 'hero.support': '支持项目', 'hero.explore': '了解适用人群', 'hero.note': '运行在你的设备上 · 不托管资金 · 可从只读或模拟开始',
  ...
  ko: {
    ...
    'hero.download': '무엇을 할 수 있는지 보기', 'hero.source': 'Nightly 다운로드', 'hero.support': '프로젝트 후원', 'hero.explore': '누구를 위한 제품인지 보기', 'hero.note': '내 기기에서 실행 · 자금 미수탁 · 읽기 전용 또는 시뮬레이션부터 시작',
  ...
  ja: {
    ...
    'hero.download': 'できることを見る', 'hero.source': 'Nightlyをダウンロード', 'hero.support': 'プロジェクトを支援', 'hero.explore': '対象ユーザーを見る', 'hero.note': '端末上で実行 · 資金を預からない · 読み取り専用またはシミュレーションから開始',
...
const workflowCopy = {
  "zh-CN": {
    ...
    "art.label": "从市场输入，到受控运行时",
    "art.title0": "配置多标的工作流",
    "art.body0": "行情、指标和信号进入同一个共享运行时。",
    "art.title1": "计算证据，形成策略状态",
    "art.body1": "指标和规则形成可追踪的决策上下文。",
    "art.title2": "让策略 Agent 判断条件",
    "art.body2": "运行时检查信号、目标与当前工作流状态。",
    "art.title3": "通过风控与审批闸门",
    "art.body3": "权限、限制和人工审查位于意图与行动之间。",
    "art.title4": "执行、对账并发送通知",
    "art.body4": "订单、成交、持仓和 Provider 回执都保留在运行记录中。",
    "art.note": "概念动画 · 运行数据与结果均为合成示例。",
    "art.markets": "运行时输入与输出",
    "art.market.cn": "行情数据",
    "art.market.hk": "指标计算",
    "art.market.us": "新闻与信号",
  ...
  "en": {
    ...
    "art.label": "From market inputs to a controlled runtime",
    "art.title0": "Configure the multi-instrument workflow",
    "art.body0": "Market data, indicators, and signals enter one shared runtime.",
    "art.title1": "Compute evidence and strategy state",
    "art.body1": "Indicators and rules become a traceable decision context.",
    "art.title2": "Let the strategy Agent evaluate conditions",
    "art.body2": "The runtime checks signals, targets, and the current workflow state.",
    "art.title3": "Pass the risk and approval gate",
    "art.body3": "Permissions, limits, and human review stay between intent and action.",
    "art.title4": "Execute, reconcile, and notify",
    "art.body4": "Orders, fills, positions, and provider receipts remain visible in the run.",
    "art.note": "Concept animation · Runtime data and results are synthetic.",
    "art.markets": "Runtime workflow inputs and outputs",
    "art.market.cn": "Market data",
    "art.market.hk": "Indicators",
    "art.market.us": "News & signals",
    "art.market.crypto": "Strategy rules",
    "art.market.metals": "Risk gate",
    "art.market.commodities": "Orders & notifications",
    "art.market.metals.detail": "Limits · permissions",
    "art.market.commodities.detail": "Execution · receipts"
  },
  "ja": {
    ...
    "art.label": "市場入力から管理されたランタイムへ",
    "art.title0": "複数銘柄ワークフローを設定",
    "art.body0": "市場のシグナルが集まり、あなたのルールが出発点になる。",
    "art.title1": "証拠を計算し、戦略状態を作る",
    "art.body1": "指標とルールが追跡可能な判断コンテキストになります。",
    "art.title2": "戦略 Agent が条件を評価",
    "art.body2": "ランタイムがシグナル、対象、現在の状態を確認します。",
    "art.title3": "リスクと承認のゲートを通す",
    "art.body3": "権限、制限、利用者の確認を意図と実行の間に置きます。",
    "art.title4": "実行、照合、通知",
    "art.body4": "注文、約定、ポジション、Providerの応答を実行記録に残します。",
    "art.note": "コンセプトアニメーション · 実行データと結果は合成例です。",
    "art.markets": "ランタイムの入出力",
    "art.market.cn": "相場データ",
    "art.market.hk": "指標計算",
    "art.market.us": "ニュースとシグナル",
    "art.market.crypto": "戦略ルール",
    "art.market.metals": "リスクゲート",
    "art.market.commodities": "注文と通知",
    "art.market.metals.detail": "制限・権限",
    "art.market.commodities.detail": "実行・応答"
  },
  "ko": {
    ...
    "art.label": "시장 입력에서 통제된 런타임까지",
    "art.title0": "다중 종목 워크플로 구성",
    "art.body0": "시세 데이터, 지표와 신호가 하나의 런타임으로 들어옵니다.",
    "art.title1": "증거를 계산하고 전략 상태 구성",
    "art.body1": "지표와 규칙이 추적 가능한 판단 컨텍스트가 됩니다.",
    "art.title2": "전략 Agent가 조건 평가",
    "art.body2": "런타임이 신호, 대상과 현재 워크플로 상태를 확인합니다.",
    "art.title3": "리스크와 승인 게이트 통과",
    "art.body3": "권한, 제한과 사람의 검토가 의도와 실행 사이에 남습니다.",
    "art.title4": "실행, 대조 및 알림",
    "art.body4": "주문, 체결, 포지션과 Provider 응답을 실행 기록에 남깁니다.",
    "art.note": "컨셉 애니메이션 · 실행 데이터와 결과는 합성 예시입니다.",
    "art.markets": "런타임 입력과 출력",
    "art.market.cn": "시세 데이터",
    "art.market.hk": "지표 계산",
    "art.market.us": "뉴스와 신호",
    "art.market.crypto": "전략 규칙",
    "art.market.metals": "리스크 게이트",
    "art.market.commodities": "주문과 알림",
    "art.market.metals.detail": "제한 · 권한",
    "art.market.commodities.detail": "실행 · 영수증"
  }
};
