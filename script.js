...
const translations = {
  en: {
    ...
    'hero.download': 'See what it does', 'hero.source': 'Download Nightly', 'hero.support': 'Support me', 'hero.explore': 'See who it is for', 'hero.note': 'Runs on your device · No custody · Start read-only or simulated',
  ...
  'zh-CN': {
    ...
    'hero.download': '看看它能做什么', 'hero.source': '下载 Nightly 版', 'hero.support': '支持我', 'hero.explore': '了解适用人群', 'hero.note': '运行在你的设备上 · 不托管资金 · 可从只读或模拟开始',
  ...
  ko: {
    ...
    'hero.download': '무엇을 할 수 있는지 보기', 'hero.source': 'Nightly 다운로드', 'hero.support': '후원하기', 'hero.explore': '누구를 위한 제품인지 보기', 'hero.note': '내 기기에서 실행 · 자금 미수탁 · 읽기 전용 또는 시뮬레이션부터 시작',
  ...
  ja: {
    ...
    'hero.download': 'できることを見る', 'hero.source': 'Nightlyをダウンロード', 'hero.support': '支援する', 'hero.explore': '対象ユーザーを見る', 'hero.note': '端末上で実行 · 資金を預からない · 読み取り専用またはシミュレーションから開始',
