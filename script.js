...
const translations = {
  en: {
    ...
    'closing.github': 'Open the user guide', 'closing.feedback': 'Feedback & discussions', 'footer.feedback': 'Feedback & discussions', 'footer.tagline': 'Multi-provider trading workstation.', 'footer.status': 'Pre-release software',
  ...
  'zh-CN': {
    ...
    'closing.github': '打开使用指南', 'closing.feedback': '反馈与交流', 'footer.feedback': '反馈与交流', 'footer.tagline': '多 Provider 交易工作站。', 'footer.status': '首版发布前软件',
  ...
  ko: {
    ...
    'closing.github': '사용 가이드 열기', 'closing.feedback': '피드백 및 토론', 'footer.feedback': '피드백 및 토론', 'footer.tagline': '멀티 프로바이더 트레이딩 워크스테이션.', 'footer.status': '출시 전 소프트웨어',
  ...
  ja: {
    ...
    'closing.github': '利用ガイドを開く', 'closing.feedback': 'フィードバックと交流', 'footer.feedback': 'フィードバックと交流', 'footer.tagline': 'マルチプロバイダー取引ワークステーション。', 'footer.status': 'リリース前ソフトウェア',
